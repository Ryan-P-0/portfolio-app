...
export default function Projects() {
    return (
      <Box as="main" m={5}>
        <Text as="h1" fontSize="3.5em" fontWeight="500" my={5}>LoadLink</Text>
        <Box bg="tyrianPurple.100" p={5}>
          <Flex>
            <a href="https://app.loadlink.com.au/" target="_blank">
              <Flex alignItems="center" gap={1}>
                <Text color="tyrianPurple.500" fontWeight="bold" decoration="underline">LoadLink React App</Text>
          ...
          <Box>
            ...
            <Box as="ul">
                <Box as="li" mx={5}>Shippers post loads onto the app board for public viewing.</Box>
                <Box as="li" mx={5}>Each load has its own detailed single page view with all information.</Box>
                <Box as="li" mx={5}>Carriers may subscribe to the site in order to view a load's shipper contact details.</Box>
                <Box as="li" mx={5}>...</Box>
            </Box>
          </Box>
        </Box>
